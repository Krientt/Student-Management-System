...
@section('title','Add Feature Details')
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form role="form" action="{{route('admin.features.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="show_in_home" class="form-control" id="exampleForStatus">
