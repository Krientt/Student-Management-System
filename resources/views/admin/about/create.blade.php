...
@section('title','Add About Details')
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form role="form" action="{{route('admin.details.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            <div class="form-group">
                                <label for="Fortitle">Unique ID</label>
                                <input type="text" class="form-control" name="title" id="Fortitle" placeholder="Enter ID" required>
                            </div>
                            <div class="form-group">
                                <label for="Forquote">Principal Quote</label>
                                <textarea name="quote" class="form-control" id="Forquote" cols="30" rows="10"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="Forhistory">Academic History</label>
                                <textarea name="history" class="form-control" id="Forhistory" cols="30" rows="10"></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name='email' class="form-control" id="Foremail" placeholder="Email" required>
                            </div>
                            <div class="item form-group">
                                <label for="Forcontact">Contact</label>
                                <input type="text" name="contact" class="form-control" id="Forcontact" placeholder="Contact">
                            </div>
                            <div class="form-group">
