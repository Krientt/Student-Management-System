...
class VisitorController extends Controller
{
    ...
    public function index()
    {
        ...
        // return view('admin.visitor.register',compact('visitors'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $visitor->save();
        return redirect()->route('admin.student.create')->with(['success' => 'Registered successfully.']);
    }
    ...
    public function show()
    {
        ...
        return view('admin.visitor.details', compact('visitors'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $visitor->Phone_Number = $request->Phone_Number;
        $visitor->update();
        return redirect()->route('admin.student.view')->with(['success' => 'Student Record Updated Successfully']);
    }
    ...
    {
        $visitor = Visitor::where('id', $id)->first();
        $like = Like::where('visitor_id', $visitor->id)->delete();
        $visitor->delete();
        return back()->with(['success' => 'Student Record Deleted Successfully'], compact('like'));
    }
}
